   ...
   public class CcdAcquisitionExample
   {
       public static async Task MainAsync()
       {
           ...
           try
           {
               ...
               var centerWavelengths =
                   await Ccd.CalculateRangePositionsAsync(Mono.DeviceId, startWavelength, endWavelength, 100);
       ...
       private static async Task<List<List<float>>> FilterValuesAsync(double startWavelength, double endWavelength,
           List<float> wavelengthValues, List<float> intensityValues)
       {
